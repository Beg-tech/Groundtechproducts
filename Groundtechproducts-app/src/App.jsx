...
export default function App() {
  ...
  return (
    <div style={{
        ...
        <div className="container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 24px" }}>
          ...
          <button onClick={() => scrollTo("#home")} style={{ display: "flex", alignItems: "center", background: "none", border: "none", cursor: "pointer", padding: 0 }}>
           <div style={{
                ...
                display: "flex",
                alignItems: "center",
                boxShadow: "0 2px 12px rgba(64,210,170,0.25)",
                transition: "box-shadow 0.3s",
              }}
              onMouseEnter={e => e.currentTarget.style.boxShadow = "0 4px 20px rgba(64,210,170,0.5)"}
              onMouseLeave={e => e.currentTarget.style.boxShadow = "0 2px 12px rgba(64,210,170,0.25)"}
            >
              <img 
      ...
      {/* CONTACT */}
      <section id="contact" className="section" style={{ background: "#0A0E28", width: "100%" }}>
        <div className="container">
              ...
              <FadeIn delay={0.15}>
                <div style={{
                  ...
                  <div style={{ marginBottom: 24 }}>
                    ...
                    {["enquiry@groundtechproducts.com"].map(e => (
